...
const generateToken = (id, email) =>{    //el generado lo necesitamos en la funcion del LOGIN

    if(!id || !email){  //tenemos que tener uno de los dos para poder generar el token
